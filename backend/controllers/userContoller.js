...
export const deleteUser = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ success: false, message: `${err}  ...Failed to delete. Try again` })
  }
}
...
export const getSingleUser = async (req, res) => {
  ...
  try {
    ...
    res.status(404).json({ success: true, message: 'Successful', data: user })
  } catch (err) {
...
export const getAllUser = async (req, res) => {
  ...
  try {
    ...
    res.status(404).json({ success: true, message: 'Successful', data: users })
  } catch (err) {
    res.status(500).json({ success: false, message: `${err}  ...Not found` })
  }
}